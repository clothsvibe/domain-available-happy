...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    if (error) {
      ...
      throw new Error("Failed to store inquiry data");
    }
    ...
    const ownerEmailResponse = await resend.emails.send({
      from: "Domain Inquiry <onboarding@resend.dev>",
      to: ["sale@mamadrop.ma"], // Replace with your actual email
    ...
    console.log("Emails sent successfully:", { userEmailResponse, ownerEmailResponse });
